...
{
    public partial class sanatcideger : Form
    {
        public sanatcideger()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            //ekle
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into sanatcidegerlendirme (degerlendirmeid,sanatciid,puan,yorum) values (@p1,@p2,@p3,@p4)", baglanti);
        ...
        {
          //listeleme
                string sorgu = "select * from sanatcidegerlendirme";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Bağlantıyı açın
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("Delete from sanatcidegerlendirme where degerlendirmeid=@p1", baglanti);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            //guncelle
            baglanti.Open();
            NpgsqlCommand komut3 = new NpgsqlCommand("update sanatcidegerlendirme set sanatciid=@p2,puan=@p3,yorum=@p4 where degerlendirmeid=@p1", baglanti);
