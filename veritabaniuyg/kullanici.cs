...
namespace veritabaniuyg
{
    public partial class kullanici : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //ekle
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into kullanicilar (kullaniciid,kullaniciadi,email,sifre,AylikDinlenmeDakikasi) values (@p1,@p2,@p3,@p4,@p5)", baglanti);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Bağlantıyı açın
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("Delete from kullanicilar where kullaniciid=@p1", baglanti);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            //guncelle
            baglanti.Open();
            NpgsqlCommand komut3 = new NpgsqlCommand("update kullanicilar set kullaniciadi=@p1,email=@p2,sifre=@p3,aylikdinlenmedakikasi=@p4 where kullaniciid=@p5", baglanti);
