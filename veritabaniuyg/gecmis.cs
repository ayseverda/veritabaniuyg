...
namespace veritabaniuyg
{
    public partial class gecmis : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            //ekle
            baglanti.Open();
            NpgsqlCommand komut1 = new NpgsqlCommand("insert into gecmis (gecmisid,kullaniciid,sarkilar,sarkicilar) values (@p1,@p2,@p3,@p4)", baglanti);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Bağlantıyı açın
            baglanti.Open();
            NpgsqlCommand komut2 = new NpgsqlCommand("Delete from gecmis where gecmisid=@p1", baglanti);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            //guncelle
            baglanti.Open();
            NpgsqlCommand komut3 = new NpgsqlCommand("update gecmis set kullaniciid=@p1,sarkilar=@p2,sarkicilar=@p3 where gecmisid=@p4", baglanti);
